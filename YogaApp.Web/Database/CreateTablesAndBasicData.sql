...
CREATE TABLE difficulty (
                            difficulty_id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
--Create poses table
CREATE TABLE poses (
                       pose_id INT NOT NULL IDENTITY(1,1),
                       english_name NVARCHAR(MAX) NOT NULL,
                       sanskrit_name_adapted NVARCHAR(MAX),
                       sanskrit_name NVARCHAR(MAX),
                       translation_name NVARCHAR(MAX),
                       pose_description NVARCHAR(MAX),
                       pose_benefits NVARCHAR(MAX),
                       difficulty_id INT,
                       url_svg NVARCHAR(MAX),
                       url_svg_alt NVARCHAR(MAX),
